        ...
        return await ctx.write({
            components: [
                ...
                new Container().setComponents(
                    new TextDisplay().setContent(`### This guild uses an application named PluralBuddy, a _plurality_ bot. 
...
Many guilds have rules specific to PluralBuddy. Please check in with a guild administrator regarding these topics if you have further questions.`)
                ).setColor("#FCCEE8")
            ],
