...
import { AttachmentBuilder, ComponentCommand, type ComponentContext } from "seyfert";
...
export default class ExportSystemButton extends ComponentCommand {
  ...
  override filter(context: ComponentContext<typeof this.componentType>) {
    return InteractionIdentifier.Systems.Configuration.GeneralTab.ExportSystem.equals(context.customId);
  }
