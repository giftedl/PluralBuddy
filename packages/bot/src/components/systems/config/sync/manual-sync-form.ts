import { PImportTranscript, PluralKitAPISystem, PluralKitGroup, PluralKitMember } from "plurography";
import { ActionRow, Button, Container, ModalCommand, ModalContext, Separator, TextDisplay } from "seyfert";
...
import { alterCollection, importTranscriptCollection, tagCollection } from "@/mongodb";
...
export default class SetPronounsButton extends ModalCommand {
	...
	override async run(ctx: ModalContext) {
		let { system: systemPB } = await ctx.retrievePUser();
