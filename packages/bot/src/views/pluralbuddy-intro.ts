...
import { ActionRow, Button, Container, Section, SelectMenu, Separator, StringSelectMenu, StringSelectOption, TextDisplay } from "seyfert"
...
export class PluralBuddyIntro extends TranslatedView {
    ...
    pageOne() {
        ...
        paginationContainer
            .setComponents(
                [
                    new TextDisplay()
                        .setContent(`-# ${this.translations.PAGINATION_TITLE} 1/3`),
                    new ActionRow()
                        .setComponents(
                            [
                                new Button()
        ...
        return [
            new Container()
                .setComponents(
                    [
                        new TextDisplay()
                            .setContent(this.translations.INTRODUCTION_MESSAGE)
                    ]
                ),
            paginationContainer
        ]
    ...
    pageTwo() {
        ...
        paginationContainer
            .setComponents(
                [
                    new TextDisplay()
                        .setContent(`-# ${this.translations.PAGINATION_TITLE} 2/3`),
                    new ActionRow()
                        .setComponents(
                            [
                                new Button()
                                ...
                                new Button()
                                    ...
                                    .setStyle(ButtonStyle.Primary)
                                    .setCustomId(InteractionIdentifier.Setup.CreateNewSystem.Index.create()),
                            ]
                        ),
                    new Separator(),
                    new ActionRow()
                        .setComponents(
                            new StringSelectMenu()
                                .setCustomId(InteractionIdentifier.Setup.ImportSelection.Index.create())
                                ...
                                .setOptions(
                                    [
                                        new StringSelectOption()
                                            ...
                                            .setValue(InteractionIdentifier.Setup.ImportSelection.PluralKit.create()),
                                        new StringSelectOption()
                                            .setLabel("Tupperbox")
                                            .setDescription(this.translations.IMPORT_TUPPERBOX_DESCRIPTION)
                                            .setValue(InteractionIdentifier.Setup.ImportSelection.Tupperbox.create()),
                                        new StringSelectOption()
                                            .setLabel("PluralBuddy")
                                            .setDescription(this.translations.IMPORT_PLURALBUDDY_DESCRIPTION)
                                            .setValue(InteractionIdentifier.Setup.ImportSelection.PluralBuddy.create())
    ...
    createNewSystemPage(guild: PGuild, rootInteractionId: string, userId: string) {
        ...
        const filledState = guild.usersRequiredSystemTag ? ((temporarySystem.systemDisplayTag !== undefined) && (temporarySystem.systemName !== undefined)) : (temporarySystem.systemName !== undefined) 
        ...
        const systemTagElements = [
            ...
            new Section()
                .setComponents(
                    new TextDisplay()
                        .setContent(this.translations.CREATING_NEW_SYSTEM_TAG_MESSAGE
                            + (temporarySystem.systemDisplayTag !== undefined ? `\n-# ${this.translations.CREATING_NEW_SYSTEM_TAG_SET} \`${temporarySystem.systemDisplayTag}\`` : "")
                        )
                    )
                .setAccessory(
                    new Button()
                        .setStyle(temporarySystem.systemDisplayTag !== undefined ? ButtonStyle.Secondary : ButtonStyle.Primary)
                        .setLabel(
                            this.translations.CREATING_NEW_SYSTEM_TAG_BUTTON
                        )
                        .setCustomId(InteractionIdentifier.Setup.CreateNewSystem.SystemTag
                            .create(rootInteractionId))
                    )
            ]
        ...
        paginationContainer
            .setComponents(
                [
                    new TextDisplay()
                        .setContent(filledState ? this.translations.PAGE_NEW_SYS_TEXT_FILLED : this.translations.PAGE_NEW_SYS_TEXT),
                    new ActionRow()
                        .setComponents(
                            [
                                new Button()
                                ...
                                new Button()
                                    ...
                                    .setCustomId(InteractionIdentifier.Setup.Pagination.Page3.create(rootInteractionId))
        ...
        textContainer.setComponents(
            new TextDisplay().setContent(this.translations.CREATING_NEW_SYSTEM_HEADER),
            new Section()
                .addComponents(
                    new TextDisplay()
                        .setContent(this.translations.CREATING_NEW_SYSTEM_NAME_MESSAGE
                            + (temporarySystem.systemName !== undefined ? `\n-# ${this.translations.CREATING_NEW_SYSTEM_NAME_SET} \`${temporarySystem.systemName}\`` : ""))
                )
                .setAccessory(
                    new Button()
                        .setStyle(temporarySystem.systemName !== undefined ? ButtonStyle.Secondary : ButtonStyle.Primary)
                        .setLabel(this.translations.CREATING_NEW_SYSTEM_NAME_BUTTON)
                        .setCustomId(InteractionIdentifier.Setup.CreateNewSystem.Name.create(rootInteractionId))
                ),
            ...
            new Section()
                .addComponents(
                    new TextDisplay()
                        .setContent(this.translations.CREATING_NEW_SYSTEM_PRIVACY_MESSAGE
                ...
                .setAccessory(
                    new Button()
                        ...
                        .setCustomId(InteractionIdentifier.Setup.CreateNewSystem.Privacy.create(rootInteractionId))
                        .setStyle((temporarySystem.public ?? 0) > 0 ? ButtonStyle.Secondary : ButtonStyle.Primary)
                ),
        )
