...
> -# {{ reply }} Please view the DM from <@1455014942888693792> regarding case \`{{ libbyCaseId }}\`.`,
  ...
  TOO_MANY_BLACKLIST_ITEMS: "Existem muitos itens na Block. Você pode ter apenas 25 cargos na lista blocks, e 25 canais na lista blocks por vez devido a limitações modais do Discord.",
...
> -# [Terms of Service](<https://pb.giftedly.dev/docs/policies/terms>) · [Privacy Policy](<https://pb.giftedly.dev/docs/policies/privacy>)`,
  ...
  SUCCESS_ADD_ITEM_BLACKLIST: "%item% foi adicionado à lista blocks com sucesso.",
  SUCCESS_REMOVE_ITEM_BLACKLIST: "%item% foi removido da lista blocks com sucesso.",
  SUCCESS_CHANGED_SERVER_BLACKLIST: "Este servidor agora tem a seguinte configuração de lista blocks: \n%blacklist_items%",
...
> Your current prefixes are {{ prefixList }}`,
  ...
  SRV_CFG_BLACKLISTS_DESC: `**Configurar lista blocks**
> Cargos e canais podem ser colocados na lista blocks de proxying ou impossibilitar uso comandos do PluralBuddy.`,
  SRV_CFG_BLACKLISTS_ITEMS: `> Atualmente, os itens da lista blocks da guilda são: {{ list }}`,
  SRV_CFG_BLACKLISTS_ITEMS_EMPTY: "> - _Não há itens da lista blocks._",
