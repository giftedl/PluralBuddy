...
> - For å lage en ny tag, prøv å bruke %command2%`,
  ...
  ERROR_ASSIGN_PAGINATION_TOO_OLD: "2i – Den paginasjonskomponenten er for gammel, du kan ikke fortsette. Vennligst gå tilbake og trykk Tilden-knappen igjen for å få paginasjonskomponenten til å fungere igjen.",
  ERROR_NO_ALTERS: "2w – Du har ingen alter! Lag en under!",
  ERROR_NO_TAGS: "2x – Du har ingen tagger! Lag en under!",
  PK_IMPORT_START: "### PluralKit importering",
  SP_IMPORT_START: `## Simply Plural importering

SimplyPlural har blitt avviklet.`,
  PAGE_NEW_SYS_TEXT: "-# Side 3/3 · Noen felter har ikke blitt fylt up. · * Påkrevd",
  PAGE_NEW_SYS_TEXT_FILLED: "-# Side 3/3 · * Påkrevd",
  IMPORT_PLURALKIT_DESCRIPTION: "Importer fra PluralKit",
  IMPORT_TUPPERBOX_DESCRIPTION: "Importer fra TupperBox",
  IMPORT_PLURALBUDDY_DESCRIPTION: "Importer fra PluralBuddy",
  IMPORT_SIMPLYPLURAL_DESCRIPTION: "Importer fra SimplyPlural",
  IMPORT_SOURCE_DESCRIPTION: "Importer Kilde",
  ...
  ERROR_INTERACTION_TOO_OLD: "2l - Denne interaksjonen er ikke lenger følgt av serveren. (Har du ventet for lenge?)",
  ERROR_SYSTEM_DOESNT_EXIST: "2m – Denne operasjonen kan ikke bli konkludert fordi det er ikke noe system å opårere på.",
  ...
  ERROR_ALTER_DOESNT_EXIST: "2n – Denne operasjonen kan ikke bli konkludert fordi enten er det ikke noe alter å operere på, eller så er det ikke noe tilknyttet system til brukeren som startet forespørselen.",
  ERROR_ALTER_DOESNT_EXIST_SUGGESTION: "2n – Den alteren kunne ikke bli funnet. Mente du `%suggestion%`?",
  ERROR_TAG_DOESNT_EXIST: "2o - Denne operasjonen kan ikke bli konkuldert fordi enten så er det ikke noe tag å operere på, eller så er det ikke noe system tilknyttet til brukeren som startet forespørselen.",
  CREATING_NEW_SYSTEM_FORM_TITLE: "Angi System-Detaljer",
  EDIT_SYSTEM_FORM_TITLE: "Redigerer System",
  SYNCING_MANUALLY_TITLE: "Syncing Manually",
  SYNCING_AUTOMATICALLY_TITLE: "Syncing Automatically",
  WRITE_BACK_TITLE: "Writing Back",
  SYSTEM_PRONOUNS_FORM_LABEL: "Pronomen",
  SYSTEM_DESCRIPTION_FORM_LABEL: "Beskrivelse",
  SYSTEM_SYSTEM_TAG_FORM_LABEL: "System-Tagg",
  ALTER_SUCCESS_PRONOUNS: "Vellykket satte mål for @%alter% til %new%.",
  ALTER_SUCCESS_PRIVACY: "Vellyket angitte de offentlig personvernverdiene for @%alter% til %new% (%number% totale verdier).",
  ALTER_SUCCESS_DESC: "Beskrivelse ble satt for @%alter%.",
  TAG_SUCCESS_ORDER: "Velykket satte rekkefølge-tekst for @%tag%.",
  PAGINATION_TITLE: "Side",
  WAITING: "Laster inn...",
  WAITING_LONG_TERM: "Laster inn... Dette tar nok en stund. Vennligst vent et øyeblikk.",
  SUCCESSFULLY_IMPORTED: "Vellyket importerte %alter_count% alter for %system_name%.",
  CREATING_NEW_PT_FORM_TITLE: "Ny proxy tagg",
  CREATING_NEW_PT_FORM_DESC: `Pluralbuddy har lignende proxy tag-formatering i forhold til at den er like hvordan andre flertalls-botter formaterer proxy taggene sine.
> - **For eksempel:** \`text :bob\` ville vært gyldig, og proxy meldinger ender med \`bob\`.
> - Du kan valgfritt vise disse tagene med "Vis Proxy Tags" systeminnstiligen på den andre siden!`,
  CREATING_NEW_PT_FORM_LABEL: "Proxy Tag",
  CREATING_NEW_PT_ERROR: "2p – Dette er ikke formatert riktig. Husk, du må ha et prefiks og et suffiks avskilt av `text`.",
  CREATING_NEW_PT_TOO_MANY_CHARS: "2y – Det er for mange tegn på enten prefiks eller suffiks-siden. Husk, du kan bare ha 20 tegn for prefikset & 20 tegn for suffiksen.",
  SUCCESSFULLY_NEW_PT: "Vellykket opprettet en ny proxy-tag!",
  PLURALBUDDY_IMPORT_DESC: "Kopier og lim inn den eksporterte JSON dataen nedenfor:",
  PLURALBUDDY_IMPORT_ERROR: "2q – Det var feil under analyseringen:\n\n```\n%zod_errors%\n```",
  PLURALBUDDY_OPTIONS_ERROR: "2r – Det var feil under evalueringen av argumentene til den kommandoen:\n\n```\n%options_errors%\n```",
  CREATE_NEW_ALTER_DONE: "Opprettet et nytt alter i ditt system. Bruk `%prefix%alter %alter_id%` for more details.",
