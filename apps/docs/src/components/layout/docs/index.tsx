...
import { Languages, LogIn, Sidebar as SidebarIcon } from "lucide-react";
			...
			<SidebarContent {...rest}>
				<SidebarHeader>
					<div className="flex">
						<Link
							href={nav.url ?? "/"}
							className="inline-flex text-[0.9375rem] items-center gap-2.5 font-medium me-auto hover:text-fd-primary transition-all"
						>
							{nav.title}
						</Link>
						{nav.children}
