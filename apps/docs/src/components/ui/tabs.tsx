  ...
  return (
    <TabPrimitive
      ...
      className={cx(
        ...
        "selected:text-primary-subtle-fg text-muted-fg hover:bg-secondary data-selected:hover:bg-primary-subtle hover:text-fg data-selected:hover:text-primary-subtle-fg focus:ring-0",
        "disabled:opacity-50",
