  ...
  return (
    <TabPrimitive
      ...
      className={cx(
        ...
        "*:[svg]:-ms-0.5 *:[svg]:me-2 *:[svg]:size-4 *:[svg]:shrink-0 *:[svg]:self-center *:[svg]:text-muted-fg data-selected:*:[svg]:text-primary-subtle-fg",
        "data-selected:text-primary-subtle-fg text-muted-fg hover:bg-secondary data-selected:hover:bg-primary-subtle hover:text-fg data-selected:hover:text-primary-subtle-fg focus:ring-0",
        "disabled:opacity-50",
