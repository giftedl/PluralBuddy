				...
				>
					...
					<DiscordContainer accentColor="#FCCEE8">
						...
						<DiscordTextDisplay className="block">
							...
							identity while being on the same Discord account. <br />
							<br />
							However, PluralBuddy uses a Discord feature named webhooks, which
							requires all messages sent by webhooks to have the{" "}
							<DiscordCode>[APP]</DiscordCode> tag, or on older clients, the{" "}
							<DiscordCode>[BOT]</DiscordCode> tag. However, users proxying with
							PluralBuddy are not bots; infact PluralBuddy takes steps to ensure
							they aren't. <br />
							<br /> Many servers have rules specific to PluralBuddy. Please
							check in with a server administrator regarding these topics if you
